...
<body>
    ...
    <section class="klient">
      <div class="container">
        <center><h2><b>Klien Kami</b></h2></center>
        <div class="row mt-5">
          <div class="col-md-4">
            <div class="card mb-3" style="max-width: 540px;">
            <div class="row g-0">
              <div class="col-md-4">
                <img src="gambar/klien.png" class="img-fluid rounded-start" alt="...">
              </div>
              <div class="col-md-8">
                <div class="card-body">
                  <h5 class="card-title">Suzuki Motor Corporation</h5>
                  <p class="card-text">Bekerja sama dengan suzuki pada tahun 2022 dalam kampanye keselamatan berkendara dan pengenalan produk baru mereka.</p>
          ...
          <div class="col-md-4">
            ...
            <div class="row g-0">
              <div class="col-md-4">
                <img src="gambar/klien1.png" class="img-fluid rounded-start" alt="...">
              </div>
              <div class="col-md-8">
                <div class="card-body">
                  <h5 class="card-title">Honda Motor Company</h5>
                  <p class="card-text">bekerja sama  dengan Honda dalam program goes to campus untuk mengenalkan produk baru serta sosialisasi keselamatan berkendara</p>
                  <!-- <p class="card-text"><small class="text-body-secondary">Last updated 3 mins ago</small></p> -->
                </div>
              </div>
            </div>
