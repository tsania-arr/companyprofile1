            ...
            <img src="gambar/logo.png" alt="Bootstrap" width="50" class="d-inline-block align-text-center me-3" >
              ...
              <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav mx-auto">
                  ...
                  <a class="nav-link mx-2 active" aria-current="page" href="tentang.php">Tentang Kami</a>
                </div>
              </div>
            </div>
          </nav>
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="col-md-6 mt-5">
                        <img src="gambar/kami.jpg" alt="" width="100%">
                    </div>
                    <div class="col-md-6 align-items-center mt-5">
                        <p><b>E-Bike</b> adalah sebuah komunitas yang menaungi masyarakat yang memiliki ketertarikan dalam bidang otomotif khususnya motor. Selain sebagai sarana menyalurkan hobi dan membuat relasi baru <b>E-Bike</b> juga membuka usaha sebagai rental motor bagi mereka yang memiliki ketertarikan dengan otomotif tapi terhalang oleh biaya</p>
                        <a href="profile.php"><button class="kami ">Selengkapnya</button></a>
